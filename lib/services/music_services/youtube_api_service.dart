...
class YoutubeApiServices implements MusicApiService {
  Future<List<String>?> getArtistAndTracks(String singer, String song) async {
    final yt = YoutubeExplode();
    final String query = "$singer $song";
    ...
    try {
      ...
      searchResultsUrls.add(singer);
      searchResultsUrls.add(song);
